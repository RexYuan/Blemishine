...
alias uvm-on='vboxmanage startvm ubuntu20 --type headless'
alias uvm-off='vboxmanage controlvm ubuntu20 poweroff'
alias uvm-info='vboxmanage showvminfo ubuntu20'
